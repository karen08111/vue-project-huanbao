  ...
  <div class="va-carousel"
    ...
    <transition-group name="list"
     ...
     <!-- <template v-if="arrow === 'always' || (hover && arrow !== 'never')">-->
        ...
        <!--<img src="../../assets/img/shutter_1.jpg"/>-->
        <span key="next"
          class="next"
          @click="next">
          <slot name="next"> {{ nextText }}</slot>
        </span>
        <!--<img src="../../../static/img/shutter_1.jpg"/>-->
      <!--</template>-->
    </transition-group>
  </div>
        ...
        return [
          {
            id: 1,
            src:
              '../../../static/img/shutter_1.jpg'
          },
          {
            id: 2,
            src:
              '../../../static/img/shutter_2.jpg'
          },
          {
            id: 3,
            src:
              '../../../static/img/shutter_3.jpg'
          },
          {
            id: 4,
            src:
              '../../../static/img/shutter_4.jpg'
          }
        ]
      }
    },
